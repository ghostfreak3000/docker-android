...
RUN echo "y" | sdkmanager --verbose "platforms;android-25" "build-tools;25.0.0" "extras;android;m2repository" "extras;google;google_play_services" "extras;google;m2repository" "extras;google;market_apk_expansion" "extras;google;market_licensing" "extras;google;webdriver"
