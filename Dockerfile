...
RUN echo "y" | sdkmanager --verbose "patcher;v4" "tools" "platforms;android-26" "platforms;android-25" "platforms;android-26" "build-tools;25.0.0" "extras;android;m2repository" "extras;google;google_play_services" "extras;google;m2repository" "extras;google;market_apk_expansion" "extras;google;market_licensing" "extras;google;webdriver" "extras;m2repository;com;android;support;constraint;constraint-layout;1.0.0-alpha7"
